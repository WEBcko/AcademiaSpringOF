...
public class SecurityConfig{
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception{
        ...
        http
                ...
                .requestMatchers( "/api/usuario/**").hasAnyRole("ADMIN", "PERSONAL")
                .requestMatchers("/api/configuracao/**").hasRole("ADMIN")
                .requestMatchers("/api/entradasaida/**").hasAnyRole("ADMIN", "PERSONAL")
                .requestMatchers("/api/exercicio/**").hasRole("ADMIN")
                .requestMatchers("api/grupo/**").hasRole("ADMIN")
                .requestMatchers("/api/treino/**").hasRole("ADMIN")
                .requestMatchers("/api/treinoexercicios/**").hasRole("ADMIN")
